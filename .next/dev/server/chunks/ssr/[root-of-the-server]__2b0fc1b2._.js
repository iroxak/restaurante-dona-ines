...
const metadata = {
    ...
    description: "Restaurante Doña Inés en El Melón, Nogales. Comida casera chilena, colaciones empresariales, desayunos, almuerzos, cenas y catering para eventos especiales. Bar y servicios residenciales.",
    keywords: [
        "restaurante",
        "comida casera",
    ...
    openGraph: {
        ...
        description: "Comida casera con sazón de hogar, colaciones empresariales y eventos.",
        type: "website",
        images: [
            {
                url: "/foto1.jpg",
