...
// Validate ../../../src/app/api/vcard/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/vcard">> = Specific
  const handler = {} as typeof import("../../../src/app/api/vcard/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
